...
export class ArgumentMessages {
  static insufficientArgsInMessage = `${EMOJI.ERROR
  } Insufficient arguments in message`;

  static shouldNotRequestMoreThan100Args = `${EMOJI.ERROR
  } Should not request more than 100 arguments`;

  static shouldNotProvideMoreThan100Args = `${EMOJI.ERROR
  } Should not provide more than 100 arguments`;
  ...
  static shouldNotHaveRequiredArgsAfterOptional = `${EMOJI.ERROR
  } Should not have required arguments after optional arguments`;

  static messageShouldHaveNoArgs = `${EMOJI.ERROR
  } Message should not have any arguments`;
